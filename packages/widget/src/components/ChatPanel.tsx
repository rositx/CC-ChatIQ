...
const CustomStyles: React.FC = () => (
  <style>{`
    .opendesk-messages-container::-webkit-scrollbar {
      width: 5px;
    }
    .opendesk-messages-container::-webkit-scrollbar-track {
      background: transparent;
    }
    .opendesk-messages-container::-webkit-scrollbar-thumb {
      background: rgba(255, 255, 255, 0.08);
      border-radius: 4px;
    }
    .opendesk-messages-container::-webkit-scrollbar-thumb:hover {
      background: rgba(255, 255, 255, 0.15);
    }
    @keyframes opendesk-pulse-glow {
...
export const ChatPanel: React.FC<ChatPanelProps> = ({ sendMessage }) => {
  ...
  return (
    <div style={panelStyles.container}>
      <CustomStyles />
      <ChatHeader />
      <div className="opendesk-messages-container" style={panelStyles.messagesList}>
        {messages.length === 0 ? (
          <WelcomePlaceholder />
        ) : (
